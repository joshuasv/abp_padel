...
from .views import CampeonatoListView, CampeonatoDetailView, EnfrentamientoFormView, inscripcion, desinscripcion, aceptar_enfrentamiento, rechazar_enfrentamiento
